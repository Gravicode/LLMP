...
namespace LLMP.Desktop.Helpers
{
    public class GraphicsExtensions
    {
        ...
        public static byte[] ResizeImage(byte[] Data, int MaxW = 1024)
        {
            ...
            if (resourceBitmap != null)
            {
                ...
                var info = new SKImageInfo(resourceBitmap.Width, resourceBitmap.Height, SKImageInfo.PlatformColorType, SKAlphaType.Premul);

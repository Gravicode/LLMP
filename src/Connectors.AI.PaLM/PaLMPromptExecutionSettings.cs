...
public sealed class PaLMPromptExecutionSettings : PromptExecutionSettings
{
    /// <summary>
    ...
    {
        return new PaLMPromptExecutionSettings()
        {
    ...
    /// <returns>An instance of PaLMPromptExecutionSettings</returns>
    public static PaLMPromptExecutionSettings FromExecutionSettings(PromptExecutionSettings? executionSettings, int? defaultMaxTokens = null)
    {
        ...
        if (executionSettings is PaLMPromptExecutionSettings settings)
        {
            return settings;
        }
        ...
        var openAIExecutionSettings = JsonSerializer.Deserialize<PaLMPromptExecutionSettings>(json, JsonSerializerOptions.Default);//JsonOptionsCache.ReadPermissive
        if (openAIExecutionSettings is not null)
        {
            return openAIExecutionSettings;
        }

        throw new ArgumentException($"Invalid execution settings, cannot convert to {nameof(PaLMPromptExecutionSettings)}", nameof(executionSettings));
    }
    ...
    /// <param name="defaultMaxTokens">Default max tokens</param>
    /// <returns>An instance of PaLMPromptExecutionSettings</returns>
    public static PaLMPromptExecutionSettings FromExecutionSettingsWithData(PromptExecutionSettings? executionSettings, int? defaultMaxTokens = null)
    {
